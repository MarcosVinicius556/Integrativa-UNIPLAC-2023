...
function Language(){
    ...
    return(
        ...
        <div className="typesModeling">
                 ...
                 <a href=""><Cards name={ifCaseName} img = {ifCaseImg} linguage={ifCasedificult} type={ifCaseimportant} textOne={textOne} textTwo={textTwo} className={classNameIf}/></a>
                <a href=""><Cards  name={forCaseName} img = {forCaseImg} linguage={forCasedificult} type={forCaseimportant} textOne={textOne} textTwo={textTwo}  className={classNameFor}/></a>
                <a href=""><Cards  name={foreachCaseName} img = {foreachCaseImg} linguage={foreachCasedificult} type={foreachCaseimportant} textOne={textOne} textTwo={textTwo} className={classNameForeach}/></a>
                <a href=""><Cards name={whileCaseName} img = {whileCaseImg} linguage={whileCasedificult} type={whileCaseimportant} textOne={textOne} textTwo={textTwo} className={classNameWhile}/></a>
                </section>
        </div>
